            ...
            <div>
              <input
                {...register("name", {
                  ...
                  validate: (value) => {
                    if (value.trim() === "")
                      return t.contact.validation.nameEmpty;
                    if (/\d/.test(value))
                      return t.contact.validation.nameNoNumbers;
                    return true;
                  },
                })}
                type="text"
            ...
            <div>
              ...
              <input
                ...
                {...register("phone", {
                  ...
                  validate: (value) =>
                    value !== "+998 " || t.contact.validation.phoneInvalid,
                })}
              />
              {errors.phone && (
                <p className="text-red-400 text-xs mt-1">
